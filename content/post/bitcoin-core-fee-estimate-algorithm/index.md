...
- bitcoin
- fee-market
title: Bitcoin Core Fee Estimate Algorithm
---
...
{{< image-card src="fee-rate-buckets.png" kg-width="fit" caption="Fee Rate Buckets" >}}
...
{{< image-card src="confirmation-fraction.png" kg-width="fit" caption="Confirmation Fraction" >}}
...
{{< image-card src="scan-and-merge.png" kg-width="fit" caption="Buckets Merge" >}}
...
{{< image-card src="median-bucket.png" kg-width="fit" caption="Median Bucket" >}}
...
{{< image-card src="tracking-unconfirmed-transactions.png" kg-width="fit" caption="Tracking Unconfirmed Transactions" >}}

{{< image-card src="rotating-unconfirmed-transactions-counters.png" kg-width="fit" caption="Rotating Unconfirmed Transactions" >}}
...
{{< image-card src="tracking-failed-transactions.png" kg-width="fit" caption="Tracking Failed Transactions" >}}
...
{{< image-card src="decaying-moving-average.png" kg-width="fit" caption="Decaying Moving Average" >}}
...
{{< image-card src="tracking-confirmed-transactions.png" kg-width="fit" caption="Tracking Confirmed Transactions" >}}
