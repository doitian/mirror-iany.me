...
{{< image-card src="socket-handler.png" caption="Socket Handler" >}}
...
{{< image-card src="message-handler.png" caption="Message Handler" >}}

The two loops are connected at these two message queues.

{{< image-card src="two-loops.png" caption="Two Loops are connected on two queues." >}}
