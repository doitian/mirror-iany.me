...
{{< image-card src="same-svg-in-different-containers.png" caption="Same SVG in Different Size Containers" >}}
...
{{< image-card src="preserveaspectratio-none.png" caption="`preserveAspectRatio=\"none\"`" >}}
