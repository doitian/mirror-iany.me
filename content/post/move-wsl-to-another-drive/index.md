...
{{< callout type="hint" icon="fas fa-fire" title="Hint" fold="" >}}

This is a faster version credited to Slawek. The old version has been moved to the chapter [Alternative Step 2 for WSL1](#alternative-step-2-for-wsl1).
...
An alternative solution is using the tool [♯ LxRunOffline]({{< relref path="/wiki/lxrunoffline.md" lang="en" >}}).

## Alternative Step 2 for WSL1

{{< callout type="info" icon="fas fa-circle-info" title="Info" fold="" >}}
