...
{{< callout type="attention" icon="fas fa-exclamation-triangle" title="Attention" fold="" >}}
...
{{< callout type="code" icon="fas fa-code" title="Full Python code ([Gist](https://gist.github.com/doitian/b1f5c60203e9dbaffccff7d0920d9529))" fold="-" >}}
