...
我本来就在用 AutoHotkey，比如之前分享过[解决 Windows 中文输入法下 Shift + Space 快捷键的困扰]({{< relref path="/post/resolve-the-annoying-shift-space-shortcut-in-windows-chinese-input-methods.md" lang="zh" >}})。于是想让脚本先切到中文，再转发语音快捷键。但是微信输入法的全局快捷键优先级比 AutoHotkey 高。
