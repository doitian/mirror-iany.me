...
{{< image-card src="inoreader-fetches-full-text-squashed.png" caption="Automatically Fetch Full Content" >}}
...
{{< image-card src="inoreader-rule-saves-article-squashed.png" kg-width="fit" caption="Automatically Save Articles" >}}

{{< image-card src="evernote-saved-articles-squashed.png" kg-width="full" caption="Saved Articles" >}}
