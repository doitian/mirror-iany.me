...
{{< image-card src="wpr-start-recording.png" >}}
...
{{< image-card src="wpa-analyze-virtualalloc.png" >}}
...
{{< image-card src="wpa-filter-to-selection.png" >}}
...
{{< image-card src="wpa-configure-symbols-paths.png" >}}
