...
series:
- What I Touched
title: What I Touched This Week 2020-06-21
---

I'm recently working in Windows, so I take many notes about setting up the Windows environment.

* [♯ Minimize any window into system tray in Windows]({{< relref path="/post/minimize-any-window-into-system-tray-in-windows.md" lang="en" >}})
