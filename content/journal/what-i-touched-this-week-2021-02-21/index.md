...
series:
- What I Touched
title: What I Touched This Week 2021-02-21
---

I published 2 posts:

* [♯ Install macOS Big Sur in 2021]({{< relref path="/post/install-macos-big-sur-in-2021.md" lang="en" >}})
* [♯ SSH Authentication Using a YubiKey on Windows And the OpenSSH Client]({{< relref path="/post/ssh-authentication-using-a-yubikey-on-windows-and-the-openssh-client.md" lang="en" >}})
