...
{{< image-card src="cmd-m-menu.png" caption="The shortcuts menu shows all available commands and the corresponding keyboard binding." >}}
...
{{< image-card src="cmd-m-macro-group.png" caption="Shows a pallete for one action when the hot key xxx is pressed." >}}
...
{{< image-card src="shortcut-forward.png" caption="Send a global shortcut in an application from Keyboard Maestro by sending a keystroke." >}}
