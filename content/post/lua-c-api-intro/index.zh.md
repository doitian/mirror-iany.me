...
{{< image-card src="lua_stack.png" caption="Lua 栈" >}}
...
{{< image-card src="lua_setglobal.png" caption="Lua 栈变化示例" >}}
...
{{< image-card src="lua_cfunction.png" caption="Lua C 方法" >}}
...
{{< image-card src="lua_cclosure.png" caption="Lua C 闭包方法" >}}
