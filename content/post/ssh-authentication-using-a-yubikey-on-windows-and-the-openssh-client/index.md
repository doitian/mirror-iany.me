...
As mentioned in [♯ Yubico for Windows]({{< relref path="/post/yubico-for-windows.md" lang="en" >}}), I used PuTTY/Plink instead of the OpenSSH client together with YubiKey because the OpenSSH Client does not support the socket file created by GnuPG.
