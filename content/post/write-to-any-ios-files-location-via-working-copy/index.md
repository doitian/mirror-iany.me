...
{{< image-card src="write-to-files-via-working-copy.png" caption="Write to Files via Working Copy" >}}
...
{{< image-card src="set-up-sync-repo-in-working-copy.jpg" caption="Set Up Sync Repo in Working Copy" >}}
...
{{< image-card src="shortcut-save-files-by-date.jpg" caption="Shortcut: Save Files by Date" >}}

Now give it a try. Share a text file using the new created action.

{{< image-card src="test-shortcut.jpg" caption="Test Shortcut" >}}

And the file appears in the `Desktop/Inbox`.

{{< image-card src="file-sorted-into-inbox.jpg" caption="File Sorted into Inbox" >}}
